...
export const STRINGS = {
  ...
  'mono.you': { en: 'You', ar: 'أنت' },
  'mono.turnTag': { en: 'playing…', ar: 'يلعب الآن' },
  'mono.landedOn': { en: 'You landed on', ar: 'حللت على' },
  'mono.cantAfford': { en: "You can't afford it — it goes to auction.", ar: 'لا تملك ثمنها — ستُطرح للمزاد.' },
  'mono.highBid': { en: 'Current bid', ar: 'أعلى مزايدة' },
  'mono.allIn': { en: 'All in', ar: 'كل النقد' },
  ...
  'mono.3dMode': { en: '3D board', ar: 'لوحة ثلاثية الأبعاد' },
  'mono.liteMode': { en: 'Lite board', ar: 'لوحة مبسّطة' },
  'mono.titleDeed': { en: 'Title Deed', ar: 'سند ملكية' },
  'mono.deedMortgageVal': { en: 'Mortgage', ar: 'قيمة الرهن' },
  'mono.deedStations': { en: 'Stations', ar: 'المحطات' },
  'mono.deedUtilOne': { en: 'If 1 owned: 4× dice', ar: 'إن مُلكت واحدة: 4× النرد' },
  'mono.deedUtilBoth': { en: 'If both owned: 10× dice', ar: 'إن مُلكت كلتاهما: 10× النرد' },
  'mono.glLost': { en: '3D unavailable — switched to Lite board.', ar: 'تعذّر العرض ثلاثي الأبعاد — تم التبديل إلى اللوحة المبسّطة.' },
  ...
  'admin.system.mundass': { en: 'Al-Mundass', ar: 'المندس' },

  // ---- المندس (Al-Mundass) — Jordanian social deduction ----
  'mundass.title': { en: 'Al-Mundass', ar: 'المندس' },
  'mundass.tagline': {
    en: 'Night in the hara. Someone among the neighbors is not who they say they are.',
    ar: 'ليل الحارة. في حدا بين الجيران مش على نياته.',
  },
  'mundass.createRoom': { en: 'Create a hara', ar: 'افتح حارة' },
  'mundass.discussionTime': { en: 'Discussion time', ar: 'وقت النقاش' },
  'mundass.tasksEach': { en: 'Chores per neighbor', ar: 'أشغال لكل جار' },
  ...
  'mundass.codePlaceholder': { en: 'CODE', ar: 'الرمز' },
  'mundass.joinBtn': { en: 'Join', ar: 'انضم' },
  'mundass.howTitle': { en: 'How it works', ar: 'كيف تلعب' },
  'mundass.how1': {
    en: 'Everyone roams the hara doing chores — tea, laundry, the satellite dish…',
    ar: 'الكل يتحرك بالحارة ويخلّص أشغاله — شاي، غسيل، ستلايت…',
  },
  'mundass.how2': {
    en: 'But one of you is the Mundass, picking neighbors off one by one.',
    ar: 'بس واحد منكم "المندس"، يصفّي الجيران واحدًا واحدًا.',
  },
  'mundass.how3': {
    en: 'Find a body — or bang the mihbash — to gather the hara, discuss, and vote.',
    ar: 'لقيت جثة؟ أو دقّ المهباش — تجتمع الحارة، تتناقشون وتصوّتون.',
  },
  'mundass.how4': {
    en: 'Crew wins by finishing all chores or voting the Mundass out. The Mundass wins by outnumbering the crew.',
    ar: 'أهل الحارة يفوزون بإنهاء الأشغال أو بطرد المندس. المندس يفوز إذا صار عددهم مثل عدد الباقين.',
  },
  'mundass.err.join': { en: 'Could not join the room.', ar: 'تعذّر الانضمام إلى الغرفة.' },
  'mundass.err.notFound': { en: 'Room not found.', ar: 'الغرفة غير موجودة.' },
  'mundass.back': { en: 'Back to Al-Mundass', ar: 'عودة إلى المندس' },
  ...
  'mundass.waitingHost': { en: 'Waiting for the host to start…', ar: 'بانتظار المضيف ليبدأ…' },
  'mundass.leave': { en: 'Leave', ar: 'مغادرة' },
  'mundass.closedInactive': { en: 'This room was closed for inactivity.', ar: 'أُغلقت هذه الغرفة لعدم النشاط.' },
  'mundass.closedAdmin': { en: 'This room was closed by an admin.', ar: 'أغلق المشرف هذه الغرفة.' },
  'mundass.reconnecting': { en: 'Reconnecting…', ar: 'إعادة الاتصال…' },

  // roles
  'mundass.youAreMundass': { en: 'You are the MUNDASS', ar: 'أنت المندس!' },
  'mundass.youAreCrew': { en: 'You are one of the neighbors', ar: 'أنت من أهل الحارة' },
  'mundass.mundassGoal': {
    en: 'Blend in. Fake your chores. Pick them off — and don’t get caught.',
    ar: 'اندمج بينهم، مثّل إنك تشتغل، وصفّيهم واحدًا واحدًا — بس لا تنكشف.',
  },
  'mundass.crewGoal': {
    en: 'Finish the chores, watch your back, and vote the Mundass out.',
    ar: 'خلّص الأشغال، دير بالك على حالك، وصوّتوا لطرد المندس.',
  },
  'mundass.yourMate': { en: 'Your fellow mundass', ar: 'شريكك المندس' },
  'mundass.roleMundass': { en: 'Mundass', ar: 'المندس' },
  'mundass.roleCrew': { en: 'Neighbor', ar: 'من أهل الحارة' },

  // HUD
  'mundass.taskBar': { en: 'Hara chores', ar: 'أشغال الحارة' },
  'mundass.yourTasks': { en: 'Your chores', ar: 'أشغالك' },
  'mundass.fakeTasks': { en: '"Your chores" (fake it!)', ar: '"أشغالك" (مثّل!)' },
  'mundass.doTask': { en: 'Do chore', ar: 'اشتغل' },
  'mundass.report': { en: 'Report!', ar: 'بلّغ!' },
  'mundass.bangMihbash': { en: 'Bang the mihbash', ar: 'دقّ المهباش' },
  'mundass.mihbashUsed': { en: 'Mihbash used', ar: 'استعملت المهباش' },
  'mundass.fixPower': { en: 'Fix the power', ar: 'صلّح الكهرباء' },
  'mundass.useManhole': { en: 'Manhole', ar: 'البالوعة' },
  'mundass.sabotage': { en: 'Cut the power', ar: 'اقطع الكهرباء' },
  'mundass.powerCut': {
    en: 'Power cut! Someone get to the breaker in the electrical room!',
    ar: 'انقطعت الكهرباء! حدا يوصل لصندوق الكهرباء!',
  },
  'mundass.ghostHint': {
    en: 'You are a spirit now — keep finishing your chores to help the hara.',
    ar: 'صرت روحًا — كمّل أشغالك لتساعد أهل الحارة.',
  },

  // task names (shared with the map stations)
  'mundass.task.wires': { en: 'Connect the wires', ar: 'وصّل الأسلاك' },
  'mundass.task.tea': { en: 'Make the tea', ar: 'اعمل شاي' },
  'mundass.task.satellite': { en: 'Fix the satellite', ar: 'ظبّط الستلايت' },
  'mundass.task.laundry': { en: 'Hang the laundry', ar: 'انشر الغسيل' },
  'mundass.task.coffee': { en: 'Grind the coffee', ar: 'اطحن القهوة' },
  'mundass.task.plants': { en: 'Water the plants', ar: 'اسقِ الزرع' },
  'mundass.task.olives': { en: 'Pick the olives', ar: 'اقطف الزيتون' },
  'mundass.task.shelf': { en: 'Stock the shelf', ar: 'رتّب الدكانة' },
  'mundass.task.gas': { en: 'Swap the gas cylinder', ar: 'بدّل جرة الغاز' },
  'mundass.task.water': { en: 'Fill the jerrycan', ar: 'عبّي المي' },

  // meeting
  'mundass.meetBody': { en: '{name} found {victim}!', ar: '{name} لقى {victim}!' },
  'mundass.meetEmergency': { en: '{name} banged the mihbash!', ar: '{name} دقّ المهباش!' },
  'mundass.discussion': { en: 'Discussion', ar: 'النقاش' },
  'mundass.voting': { en: 'Voting', ar: 'التصويت' },
  'mundass.vote': { en: 'Vote', ar: 'صوّت' },
  'mundass.skipVote': { en: 'Skip vote', ar: 'امتنع عن التصويت' },
  'mundass.skip': { en: 'Skip', ar: 'امتناع' },
  'mundass.voteCast': { en: 'Vote cast — waiting for the rest…', ar: 'تم التصويت — بانتظار البقية…' },
  'mundass.ejected': { en: '{name} was kicked out of the hara.', ar: 'انطرد {name} من الحارة.' },
  'mundass.wasMundass': { en: 'They WERE the Mundass!', ar: 'كان المندس!' },
  'mundass.notMundass': { en: 'They were not the Mundass…', ar: 'ما كان المندس…' },
  'mundass.noEjection': { en: 'No one was ejected.', ar: 'ما انطرد حدا.' },
  'mundass.abstained': { en: 'Abstained', ar: 'ممتنعون' },
  'mundass.chatHint': { en: 'Discuss — who is acting suspicious?', ar: 'تناقشوا — مين تصرفاته مريبة؟' },
  'mundass.chatPlaceholder': { en: 'Say something…', ar: 'احكِ شي…' },
  'mundass.ghostChat': { en: 'Spirit chat (only spirits see this)', ar: 'دردشة الأرواح (بس الأرواح يشوفوها)' },

  // end screen
  'mundass.crewWin': { en: 'The neighbors win! The hara is safe.', ar: 'أهل الحارة انتصروا! الحارة بأمان.' },
  'mundass.mundassWin': { en: 'The Mundass wins! The hara has fallen.', ar: 'المندس انتصر! سقطت الحارة.' },
  ...
  'mundass.rej.not_host': { en: 'Only the host can start.', ar: 'المضيف فقط يبدأ اللعبة.' },
  'mundass.rej.already_started': { en: 'The game already started.', ar: 'اللعبة بدأت بالفعل.' },
  'mundass.rej.you_are_dead': { en: 'Spirits cannot do that.', ar: 'الأرواح ما بتقدر تعمل هيك.' },
  'mundass.rej.ghosts_cannot_vote': { en: 'Spirits cannot vote.', ar: 'الأرواح ما بتصوّت.' },
  'mundass.rej.already_voted': { en: 'You already voted.', ar: 'صوّتت بالفعل.' },
  'mundass.rej.game_over': { en: 'The game is over.', ar: 'انتهت اللعبة.' },
  'mundass.rej.not_in_room': { en: 'You are not in this room.', ar: 'أنت مش بهالغرفة.' },
}
